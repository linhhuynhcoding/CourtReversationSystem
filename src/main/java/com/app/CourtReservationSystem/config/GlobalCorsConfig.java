    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**") // Apply CORS policy to all endpoints
                .allowedOrigins("http://localhost:3000", "http://172.19.128.1" +
                        ":3000", "http://192.168.1.9:3000", "https://court-reservation-web-git-main-linhhuynhcodings-projects.vercel.app", "http://192.168.1.250:3000", "https://court-reservation-web.vercel.app") // Allowed origins
